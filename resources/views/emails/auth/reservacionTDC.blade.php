...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        <style type="text/css">
            ...
            .footer .forwardtoafriend {
                background-image: url(https://i4.createsend1.com/static/eb/master/09-onyx/imgf/forward.png);
            }
            @media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx) {
                ...
                .footer .tweet {
                    background-image: url(https://i2.createsend1.com/static/eb/master/09-onyx/imgf/tweet@2x.png) !important;
                }
                .footer .linkedinshare {
                    background-image: url(https://i5.createsend1.com/static/eb/master/09-onyx/imgf/lishare@2x.png) !important;
                }
                .footer .forwardtoafriend {
                    background-image: url(https://i6.createsend1.com/static/eb/master/09-onyx/imgf/forward@2x.png) !important;
                }
            }
            @media only screen and (max-width: 620px) {
                .footer {
            ...
            .one-col .column .contents blockquote {
                background-image: url(https://i7.createsend1.com/static/eb/master/09-onyx/images/quote-double-large.png);
            }
            .two-col .column .contents blockquote {
                background-image: url(https://i8.createsend1.com/static/eb/master/09-onyx/images/quote-double.png);
            }
            .three-col .column .contents blockquote,
            .two-col .column-narrower .contents blockquote {
                background-image: url(https://i1.createsend1.com/static/eb/master/09-onyx/images/quote-single.png);
            }
            .two-col .column-narrower .contents blockquote {
                background-image: url(https://i1.createsend1.com/static/eb/master/09-onyx/images/quote-single.png);
            }
            ...
            .contents ul li {
                list-style-image: url(https://i9.createsend1.com/static/eb/master/09-onyx/images/bullet.png);
            }
            ...
            .one-col-feature .contents blockquote ul:first-child {
                background-image: url(https://i5.createsend1.com/static/eb/master/09-onyx/images/quote-top-feature.png);
            }
            .wrapper blockquote * {
                font-style: italic;
            }
            ...
            @media (-webkit-min-device-pixel-ratio: 1.5) and (min-width: 620px), (min-resolution: 144dpi) and (min-width: 620px) {
                ...
                .one-col .column .contents blockquote {
                    ...
                    background-image: url(https://i3.createsend1.com/static/eb/master/09-onyx/images/quote-double-large@2x.png);
                }
                .two-col .column .contents blockquote {
                    background-size: 28px !important;
                    background-image: url(https://i6.createsend1.com/static/eb/master/09-onyx/images/quote-double@2x.png);
                }
                .three-col .column .contents blockquote,
                .two-col .column-narrower .contents blockquote {
                    background-size: 15px !important;
                    background-image: url(https://i4.createsend1.com/static/eb/master/09-onyx/images/quote-single@2x.png);
                }
                .two-col .column-narrower .contents blockquote {
                    background-size: 15px !important;
                    background-image: url(https://i4.createsend1.com/static/eb/master/09-onyx/images/quote-single@2x.png);
            ...
            @media (-webkit-min-device-pixel-ratio: 1.5), (min-resolution: 144dpi), (max-width: 620px) {
                [class=wrapper] .one-col-feature blockquote {
                    ...
                    background-image: url(https://i7.createsend1.com/static/eb/master/09-onyx/images/quote-bottom-dark@2x.png) !important;
                ...
                [class=wrapper] .one-col-feature blockquote ul:first-child {
                    background-size: 30px !important;
                    background-image: url(https://i8.createsend1.com/static/eb/master/09-onyx/images/quote-top-dark@2x.png) !important;
                    background-position: 50% 0% !important;
                }
                [class=wrapper] .contents ul li {
                    background: transparent url(https://i1.createsend1.com/static/eb/master/09-onyx/images/bullet@2x.png) no-repeat top left !important;
                }
                ...
                [class=wrapper] .one-col-feature ul li {
                    ...
                    background: transparent url(https://i10.createsend1.com/static/eb/master/09-onyx/images/bullet-large@2x.png) no-repeat top left !important;
            ...
            @media (-webkit-min-device-pixel-ratio: 1.5) and (max-width: 620px), (min-resolution: 144dpi) and (max-width: 620px) {
                ...
                [class=wrapper] .three-col .divider {
                    background-image: url(https://i2.createsend1.com/static/eb/master/09-onyx/images/divider-waves@2x.png) !important;
                }
            }
            @media only screen and (max-width: 620px) {
                ...
                [class=wrapper] .contents blockquote {
                    background-image: url(https://i6.createsend1.com/static/eb/master/09-onyx/images/quote-double@2x.png) !important;
    ...
    <![endif]-->
    <!--[if !mso]><!-->
    <body class="full-padding" style="margin: 0;padding: 0;min-width: 100%;background-color: #1e1e1e;">
        <!--<![endif]-->
        <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #1e1e1e;">
            <table class="preheader" style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #161616;">
                <tbody><tr>
                        <td class="title" style="padding: 9px;vertical-align: top;font-family: Cabin,Avenir,sans-serif;color: #e6e6e6;font-size: 11px;line-height: 16px;text-align: left;">Confirmaci&#243;n de la Reservacion Sistema de Booking</td>
                                            ...
                                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%;">
                                                <tbody><tr>
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word;text-align: left;">
                                                            ...
                                                            <h3 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 32px;font-size: 16px;line-height: 24px;font-family: Cabin,Avenir,sans-serif;color: #707f8f;text-align: center;">
                                                                Hola {!!$nombrepara!!}, gracias por preferirnos.
                                                            </h3>
                                                            ...
                                                            <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 12px;font-size: 30px;line-height: 40px;font-family: Cabin,Avenir,sans-serif;color: #d49344;text-align: center;">
                                                                Confirmaci&#243;n de la Reservaci&#243;n Sistema de Booking iWaNaTrip.com</h1>
                                                             ...
                                                             <p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Cabin,Avenir,sans-serif;color: #fff;">
                                                                Consulta de la Reservaci&#243;n:</p>
                                                            <div style="text-align:center;">
                                                                <a href="{!!$url!!}" target="_blank" style="font-family: Cabin,Avenir,sans-serif;color: #d49344;font-weight: bold;text-align: center">Ver Reservaci&#243;n</a>
                                                            </div>
                                                        ...
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word;text-align: left;">
                                                            ...
                                                            <!--<div class="btn btn--center" style="Margin-bottom: 0;Margin-top: 0;text-align: center;">
                                                                <![if !mso]><a style="border-radius: 3px;display: inline-block;font-size: 14px;font-weight: 700;line-height: 24px;padding: 13px 35px 12px 35px;text-align: center;text-decoration: none !important;transition: opacity 0.2s ease-in;color: #fff;font-family: Cabin,Avenir,sans-serif;background-color: #4c5b6b;" href="http://www.iguanatrip.com">
                                                                    Registro de operadores</a><![endif]>
                                                            </div> -->
                                ...
                                <tbody><tr>
                                        <td style="padding: 0;vertical-align: top;color: #e6e6e6;font-size: 12px;line-height: 22px;text-align: left;width: 400px;">
                                            ...
                                            <div class="permission" style="font-family: Cabin,Avenir,sans-serif;">
                                                <div>Has recibido la Confirmaci&#243;n de tu Reserva a traves del Sistema de Booking</div>
                                            </div>
