                        ...
                        <div class="row add-clearfix same-height">
                            <div class="col-sm-6 col-md-3">
                                ...
                                <ul class="recent-posts">
                                    ...
                                    <li>
                                        <a href="https://iwanatrip.com/detalle/Centro-HistOrico-de-Quito/127" class="post-author-avatar"><span><img src="{!! asset('public/images/icon/127images.jpg')!!}" alt=""></span></a>
                                        <div class="post-content">
                                            <a href="https://iwanatrip.com/detalle/Centro-HistOrico-de-Quito/127" class="post-title">Centro Histórico de Quito</a>
                                            <p class="post-meta">By <a href="#">Admin</a>  .  12 Feb, 2016</p>
                                        </div>
                                    </li>
                                    
                                        <a href="https://iwanatrip.com/detalle/MalecOn-San-CristObal/232" class="post-author-avatar"><span><img src="{!! asset('public/images/icon/232img9106.jpg')!!}" alt=""></span></a>
                                        <div class="post-content">
                                            <a href="https://iwanatrip.com/detalle/MalecOn-San-CristObal/232" class="post-title">Malecón San Cristóbal</a>
                                            <p class="post-meta">By <a href="#">Admin</a>  .  12 Feb, 2016</p>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <div class="tags">
                                    <a href="https://iwanatrip.com/Search?s=GalApagos" class="tag">Galápagos</a>
                                    <a href="https://iwanatrip.com/Search?s=Centro HistOrico" class="tag">Centro Histórico</a>
                                    <a href="https://iwanatrip.com/Search?s=BaNos" class="tag">Baños</a>
