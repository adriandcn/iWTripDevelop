...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWaNaTrip | {{ trans('booking/labels.label32')}}</title>
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            <ul class="breadcrumbs">
                <li class="active">{{ trans('booking/labels.label32')}}</li>
            </ul>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div id="main" class="col-sm-12 col-md-12">
                            <h1 class="entry-title" style="text-align:center;padding:2%;">{{ trans('booking/labels.label9')}}</h1>
                            <div class="product type-product">
                            
                            
                 <div class="woocommerce-tabs tab-container vertical-tab clearfix box pdfprint" >
                         ...
                         <div class="row" id="pdfprint">
                                ...
                                <div class="woocommerce-billing-fields box">
                                    ...
                                    <div class="form-group column-2 no-column-bottom-margin">
                                        <label style="padding-bottom:0.5%;">{{ trans('booking/labels.label1')}}</label>
                                    ...
                                    <div class="form-group">
                                        <label style="padding-bottom:0.5%;">{{ trans('booking/labels.label2')}}</label>
                            ...
                            <div class="col-sm-6 pdfmain">

                            <h4>{{ trans('booking/labels.label7')}}</h4>
                            <div id="content2" class="pdf">
                        ...
                        <!-- <button class="btn btn-default" onclick="printContent('print');">{{ trans('booking/labels.label22')}}</button>-->
