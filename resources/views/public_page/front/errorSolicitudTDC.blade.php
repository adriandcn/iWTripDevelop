...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWaNaTrip | {{ trans('booking/labels.tdclabel7')}}</title>
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            <ul class="breadcrumbs">
                <li class="active">{{ trans('booking/labels.tdclabel7')}}</li>
            </ul>
        </div>
            <script type='text/javascript'>
			   swal(
                          '{{ trans("booking/labels.tdclabel5")}}',
			  '{{ trans("booking/labels.tdclabel6")}}',
			  'error');
            </script>
        <section id="content">
            <div class="container">
                <div class="row" id="print">
                    <div id="main" class="col-sm-12 col-md-12">
                        <h1 class="entry-title" style="text-align:center;padding:4%;">{!!$mensaje!!}</h1>
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount">{!!$infoPago[0]->nombre_calendario!!}</span>
                                                </td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount">{{ trans('booking/labels.label44')}}</span>
                                                </td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount">{!!$infoPago[0]->fecha_pago!!}</span>
                                                </td>
                                            </tr>  
                                        </tbody>
                                        <tfoot>
                                            <tr class="product-name">
                                                ...
                                                <td><span class="amount"> <strong>{!!$infoReservas[0]->amount!!} $</strong></span></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    <div id="payment">
                                        ...
                                        <ul class="payment_methods methods box-sm">
                                            <li class="payment_method_paypal">
                                                    <i class="fa fa-credit-card fa-2x" aria-hidden="true" style="margin-right: 2%;"></i> 
                                                    {{ trans('booking/labels.label39')}} 
                        ...
                        <!-- BOTONES PARA IMPRIMIR Y REDIRECCION-->
                        <div class="text-center">
                                <button class="btn btn-default" id="create_pdf">{{ trans('booking/labels.label22')}}</button>     
                                <button class="btn btn-default" onclick="window.location.href ='https://iwanatrip.com/'">{{ trans('booking/labels.label23')}}</button>
                        </div>
                    </div>
                </div>
            </div>
...
function generate() {
  ...
  doc.save('Reservacion-{!!$infoReservas[0]->c_name!!}-{!!$infoPago[0]->fecha_pago!!}.pdf');
}
