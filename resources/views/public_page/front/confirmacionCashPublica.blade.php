...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWaNaTrip | {{ trans('booking/labels.label35')}}</title>
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            <ul class="breadcrumbs">
                <li class="active">{{ trans('booking/labels.label35')}}</li>
            </ul>
        </div>
            <script type='text/javascript'>
			   swal(
                          '{{ trans("booking/labels.label37")}}',
            ...
            <div class="container">
                <div class="row" id="print">
                    <div id="main" class="col-sm-12 col-md-12">
                        <h1 class="entry-title" style="text-align:center;padding:4%;">{{ trans('booking/labels.label36')}}</h1>
                                    ...
                                    <table class="shop_table box" id="basic-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount">{{ trans('booking/labels.label42')}}</span>
                                                </td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                    ...
                                    <div id="payment">
                                        ...
                                        <ul class="payment_methods methods box-sm">
                                            <li class="payment_method_paypal">
                                                <label>
                                                    {{ trans('booking/labels.label38')}} <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQdNX4hBtGyYkdms_f198WCf7YN8SlvPKfGq2nQyR_-Dw0rcgX" width="30%;" height="10%;">
                                                </label>
                                            </li>
                                        </ul>
                                        <div class="clear"></div>
