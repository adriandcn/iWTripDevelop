                    ...
                    <div id="main" class="col-sm-8 col-md-9">
                     ...
                     <div class="post-filters">
                            <a href="#" class="btn btn-sm style4 hover-blue active" data-filter="filter-all">All</a>
                                <a href="#" class="btn btn-sm style4 hover-blue" data-filter="filter-see">See & do</a>
                                <a href="#" class="btn btn-sm style4 hover-blue" data-filter="filter-eat">Eat & Drink</a>
                                <a href="#" class="btn btn-sm style4 hover-blue" data-filter="filter-sleep">Sleep</a>
    ...
    $( ".searchCity" ).autocomplete({
      ...
      source: availableTags
       ...
       $('.scrollup').click(function () {
                                                                ...
                                                                $('html, body').animate({scrollTop: parseInt($(".post-filters").offset().top)}, 2000);
