...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>{!!$promocion[0]->nombre_promocion!!} | iWaNaTrip</title>
        <!-- Meta Tags -->
        <meta charset="utf-8">
        <meta name="_token" content="{!! csrf_token() !!}"/>
                                    
        <meta name="description" content='{!!$promocion[0]->nombre_promocion!!} |iWaNaTrip.com'>
        <meta name="keywords" content="{!!$promocion[0]->nombre_promocion!!}">
        ...
        <meta property="og:title" content="{!!$promocion[0]->nombre_promocion!!}" /> 
        <meta property="og:description" content="{!!$promocion[0]->nombre_promocion!!}" />
  ...
  ga('send', 'pageview');
    ...
    <body class="woocommerce">
        <div id="page-wrapper">
            ...
            @include('public_page.reusable.banner', ['titulo' =>$promocion[0]->nombre_promocion])  
                <?php $nombreAtarccion = $nombreAtraccion[0]->nombre_servicio; 
                       $usuarioServicio = $promocion[0]->id_usuario_servicio; ?>
